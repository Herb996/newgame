...
素材表结构（2026-09-20 实测，见 docs/fx_library.md 第五节的更正）：
  ...
  * 配色行固定顺序：0 橙 / 1 粉 / 2 蓝 / 3 绿 / 4 棕橙 / 5 白 / 6 土黄 / 7 红 / 8 紫
...
JOBS = [
    ...
    ("hit_arrow",     27, 1338, 6, "弓命中：横向六向虚线星芒，土黄"),
    ("hit_sniper",    33, 1618, 0, "狙命中：涂鸦放射刺星带亮核，橙"),
]
